...
REQUIRED_TESTS = (
    ...
    "duplicate_mileage_rate_identity_is_rejected",
    "overlapping_effective_rates_fail_closed",
    "non_billable_mileage_cannot_create_draft_line_proposal",
    "approved_billable_mileage_creates_one_draft_line_proposal",
